...
# Función para generar la tabla de porcentajes y gráfico de barras
def generar_tabla_porcentajes(df_resultados):
    ...
    tabla = pd.DataFrame({
        'Nota': conteo_calificaciones.index,
        'Cantidad': conteo_calificaciones.values,
    ...
    ax.bar(tabla['Nota'], tabla['Porcentaje'], color='skyblue')
    ax.set_xlabel('Nota')
    ax.set_ylabel('Porcentaje (%)')
    ax.set_title('Distribución de Calificaciones en Porcentajes')
    ax.grid(True)
    st.pyplot(fig)
            ...
            if not df.empty:
                ...
                if selected_call_ids:
                    ...
                    if resultados:
                        ...
                        # Mostrar la tabla de porcentajes y gráfico de barras
                        generar_tabla_porcentajes(df_resultados)
